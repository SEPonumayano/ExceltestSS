...
public class XLSXWtiteTest {
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        try {
            ...
            XLSXWtiteTest.setBorder(style_header, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_string, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_string_wrap, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_int, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_double, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_yen, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_percent, BorderStyle.THIN);
            ...
            XLSXWtiteTest.setBorder(style_datetime, BorderStyle.THIN);
               ...
               // cell.setCellType(CellType.STRING);
                ...
                for (int j = 0; j < 10; j++) {
                   ...
                   // cell.setCellType(CellType.FORMULA);
                    cell.setCellFormula("ROUND(" + XLSXWtiteTest.getExcelColumnString(colNumber - 3) + (rowNumber + 1) + "*1.08, 0)");
    ...
    private static String getExcelColumnString(int column) {
        ...
        if (column >= 0) {
            if (column / XLSXWtiteTest.LIST_ALPHA.length > 0) {
                result += getExcelColumnString(column / XLSXWtiteTest.LIST_ALPHA.length - 1);
            }
            result += XLSXWtiteTest.LIST_ALPHA[column % XLSXWtiteTest.LIST_ALPHA.length];
        }
